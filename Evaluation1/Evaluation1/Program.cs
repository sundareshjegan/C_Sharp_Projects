            ...
            do
            {
                ...
                switch (choice)
                {
                    ...
                    case 7:
                        ...
                        { 
                            InputValidate.ValidateInt("Enter the Scale-X : ");
                            int scaleX = InputValidate.intValue;
                            InputValidate.ValidateInt("Enter the Scale-Y : ");
                            int scaleY = InputValidate.intValue;
                            regs[id].Resize(scaleX, scaleY);
                        }
                        break;
                    case 8:
                        regs = RegionManager.GetAllRegions();
                        DisplayRegions(regs, 0);
                        Console.WriteLine("Enter the id of two regions to check : ");
                        Console.Write("Enter region-1 ID : ");
